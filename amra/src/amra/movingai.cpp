...
void MovingAI::SavePath(
	...
	int iter)
	//基于当前代码文件位置 (__FILE__) 和地图文件名 (m_fname) 构造输出路径。
	//例如：
	//输入 m_fname = "maps/map1.map"
	//输出 filename = "../../dat/solutions/map1_path.map"
	//若 iter=2，则进一步修改为 "../../dat/solutions/0002_map1_path.map"
